...
WINGDIAPI void APIENTRY glFrustum (GLdouble left, GLdouble right, GLdouble bottom, GLdouble up, GLdouble zNear, GLdouble zFar);
...
WINGDIAPI void APIENTRY glOrtho (GLdouble left, GLdouble right, GLdouble bottom, GLdouble up, GLdouble zNear, GLdouble zFar);
